...
public class RedisUtils {
    ...
    public List<Object> getListValue(String aid){
        Set<String> listKeys = getListKey(aid);
        List<Object> value = redisTemplate.opsForValue().multiGet(listKeys);
        return value;
    }

    public Set<String> getListKey(String aid){
        Set<String> keys = redisTemplate.keys(aid.concat("*"));
        return keys;
    }
